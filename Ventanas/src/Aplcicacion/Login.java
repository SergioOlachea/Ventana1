...
public class Login extends JFrame {
	...
	public Login() {
		...
		String correo = "mataabuelitas2405@gmail.com";
		String contraseña= "donJuan2325";
 	   ...
 	   panel.add(lbletiqueta1);
 	    ...
 	    btnIngresar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (txtcorreot.getText().equals("")&& !txtcorreot.getText().equals(correo)) {
				...
				if (contra.getText().equals("")&&!contra.getText().equals(contraseña)) {
